...
<body>
	...
	<div class="container">
		...
		<hr class="soft" />
		<div class="row mb-4 search-forms">
    <div class="col-md-6">
        <form:form action="tim-kiem" method="get" modelAttribute="student">
            <div class="input-group">
                <input type="text" class="form-control" name="hoTen" placeholder="Tìm kiếm theo tên" />
    ...
    <div class="col-md-6">
        <form:form action="tim-kiem-full-thong-tin" method="get" modelAttribute="student">
            <div class="input-group">
                <input type="text" class="form-control" name="hoTen" placeholder="Tìm kiếm tên + in thông tin" />
                <button type="submit" class="btn btn-success">Tìm</button>
            </div>
        </form:form>
    </div>
		...
		<div class="row">
    <form:form action="Add-Studentvip" method="POST" modelAttribute="student">
        <div class="col-md-6">
            <div class="card p-4 shadow">
                ...
                <div class="mb-3">
                  ...
                  <p style = "color :red"><form:errors path = "soDt"></form:errors> </p>
           ...
           <p style = "color :red"><form:errors path = "DiaChi"></form:errors> </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card p-4 shadow">
                ...
                <div class="mb-3">
                 ...
                 <p style = "color :red"><form:errors path = "maTruong"></form:errors> </p>
                ...
                <div class="mb-3">
                 ...
                 <p style = "color :red"><form:errors path = "maNganh"></form:errors> </p>
